...
impl Default for Options {
    fn default() -> Options {
        Options {
            ...
            cf_protection_disable_branch: false,
            cf_protection_disable_return: false,
            prints: Vec::new(),
...
pub fn rustc_short_optgroups() -> Vec<RustcOptGroup> {
    vec![
        ...
        opt::flag_s("", "cf_protection_disable_branch", "Intel CET Indirect branch tracking protection"),
        opt::flag_s("", "cf_protection_disable_return", "Intel CET shadow stack protection"),
...
pub fn build_session_options(matches: &getopts::Matches) -> Options {
    ...
    let cf_protection_disable_branch = matches.opt_present("cf_protection_disable_branch");
    let cf_protection_disable_return = matches.opt_present("cf_protection_disable_return");
    ...
    Options {
        ...
        incremental,
        debugging_opts,
        cf_protection_disable_branch,
        cf_protection_disable_return,
        prints,
        borrowck_mode,
        cg,
        error_format,
